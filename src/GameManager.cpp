...
GameManager::GameManager(const char* title, int width, int height, bool fullscreen)
{
	...
	player2 = new Entity(TransformComponent(100,100,64,64,2), StatisticsComponent(500, 100, 0.07, 100, 3), SpriteComponent("orc", true), ColliderComponent("player2", 17, 0, 30, 50), KeyboardController("player2"), HealthComponent(100));
