...
GameManager::GameManager(const char* title, int width, int height, bool fullscreen)
{
	...
	player1 = new Entity(StatisticsComponent(500, 100, 0.07, 100, 5), TransformComponent(0,0,64,64,2), SpriteComponent("orc", true), ColliderComponent("player1", 0, 0, 64, 64), KeyboardController("player1"), HealthComponent());
