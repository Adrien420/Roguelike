...
GameManager::GameManager(const char* title, int width, int height, bool fullscreen)
{
	...
	player = new Entity(TransformComponent(0,0,64,64,2), StatisticsComponent(500, 100, 0.07, 100), SpriteComponent("orc", true), KeyboardController("player1"), HealthComponent(100));
	player2 = new Entity(TransformComponent(100,100,64,64,2), StatisticsComponent(500, 100, 0.07, 100), SpriteComponent("orc", true), KeyboardController("player2"), HealthComponent(100));
